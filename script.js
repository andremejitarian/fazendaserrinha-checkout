document.addEventListener('DOMContentLoaded', () => {
    ...
    const taxasPagamento = {
        cartao: {
            ...
            2: { nome: 'Cartão - 2 parcelas', taxaFixa: 0.00, taxaPercentual: 0.08 },
            3: { nome: 'Cartão - 3 parcelas', taxaFixa: 0.00, taxaPercentual: 0.08 },
            4: { nome: 'Cartão - 4 parcelas', taxaFixa: 0.00, taxaPercentual: 0.08 },
            5: { nome: 'Cartão - 5 parcelas', taxaFixa: 0.00, taxaPercentual: 0.08 },
            6: { nome: 'Cartão - 6 parcelas sem juros', taxaFixa: 0.00, taxaPercentual: 0.00 },
            7: { nome: 'Cartão - 7 parcelas', taxaFixa: 0.00, taxaPercentual: 0.0820 },
            8: { nome: 'Cartão - 8 parcelas', taxaFixa: 0.00, taxaPercentual: 0.0866 },
            9: { nome: 'Cartão - 9 parcelas', taxaFixa: 0.00, taxaPercentual: 0.0349 },
            10: { nome: 'Cartão - 10 parcelas', taxaFixa: 0.00, taxaPercentual: 0.0349 },
